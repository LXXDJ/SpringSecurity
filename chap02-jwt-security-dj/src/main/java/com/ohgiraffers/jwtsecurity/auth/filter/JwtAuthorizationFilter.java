...
public class JwtAuthorizationFilter extends BasicAuthenticationFilter{
    ...
    private JSONObject jsonResponseWrapper(Exception e){
        ...
        if(e instanceof ExpiredJwtException) resultMsg = "Token Expired";
        else if(e instanceof SignatureException) resultMsg = "Token SignatureException";
        else if(e instanceof JwtException) resultMsg = "Token Parsing JwtException";
        else resultMsg = "other Token error";
